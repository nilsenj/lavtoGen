...
class Module extends ServiceProvider
{
    ...
    {
        return trans($this->get('description'));
    }
     ...
     * @return bool
     */
    public function moduleIsDefault()
    {
        return $this->get('default', 0) == 1;
    }
    ...
    {
        return $this->get('release_date', '00.00.0000');
    }

    /**
     * @return mixed
     */
    public function moduleAuthor()
    {
        return $this->get('author', 'anonymous');
    }

    /**
     * @return mixed
     */
    public function moduleCreated()
    {
        return $this->get('created', Carbon::yesterday());
    }
    ...
    {
        return !is_null($this->get('description')) ? \Lang::get($this->get('description')) : 'description not specified';
    }

    /**
     * @return string
     */
    public function moduleAbsentImage()
    {
        return asset($this->get('absentImage', 'images/default-module.png'));
    }

    /**
     * @return array
     */
    public function moduleReviewImages()
    {
        $imgArr = [];
        foreach ($this->get('reviewImages', []) as $key => $image) {
            if ($image) {
                $imgArr[$key] = asset($image);
            } else {
                $this->moduleAbsentImage();
            }
        }
        return $imgArr;
    }
    ...
    /**get representation of module in db
     * @return \Illuminate\Database\Eloquent\Model|null
     */
    public function DbModule(){

        return ModuleLayer::findBySlug($this->getLowerName());
    }
    /**
     * Get extra path.
     *
