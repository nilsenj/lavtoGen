...
namespace {
    ...
    class Module extends \Core\Modular\Facades\Module{
        ...
        public static function addLocation($path){
            return \Core\Modular\Repository::addLocation($path);
        }
        ...
        public static function addPath($path){
            return \Core\Modular\Repository::addPath($path);
        }
        ...
        public static function getPaths(){
            return \Core\Modular\Repository::getPaths();
        }
        ...
        public static function getScanPaths(){
            return \Core\Modular\Repository::getScanPaths();
        }
        ...
        public static function scan(){
            return \Core\Modular\Repository::scan();
        }
         ...
         */
        public static function all(){
            return \Core\Modular\Repository::all();
        }
        ...
        public static function getCached(){
            return \Core\Modular\Repository::getCached();
        }
        
        /**
         * Get all modules as collection instance.
         *
         * @return \Core\Modular\Collection 
         * @static 
         */
        public static function toCollection(){
            return \Core\Modular\Repository::toCollection();
        }
        ...
        public static function getByStatus($status){
            return \Core\Modular\Repository::getByStatus($status);
        }
         ...
         */
        public static function has($name){
            return \Core\Modular\Repository::has($name);
        }
        ...
        public static function enabled(){
            return \Core\Modular\Repository::enabled();
        }
        ...
        public static function disabled(){
            return \Core\Modular\Repository::disabled();
        }
        ...
        public static function count(){
            return \Core\Modular\Repository::count();
        }
        ...
        public static function getOrdered($direction = 'asc'){
            return \Core\Modular\Repository::getOrdered($direction);
        }
         ...
         */
        public static function getPath(){
            return \Core\Modular\Repository::getPath();
        }
        ...
        public static function register(){
            return \Core\Modular\Repository::register();
        }
         ...
         */
        public static function boot(){
            return \Core\Modular\Repository::boot();
        }
        ...
        public static function find($name){
            return \Core\Modular\Repository::find($name);
        }
        ...
        public static function get($name){
            return \Core\Modular\Repository::get($name);
        }
        ...
        public static function findOrFail($name){
            return \Core\Modular\Repository::findOrFail($name);
        }
        ...
        public static function collections(){
            return \Core\Modular\Repository::collections();
        }
        ...
        public static function getModulePath($module){
            return \Core\Modular\Repository::getModulePath($module);
        }
        ...
        public static function assetPath($module){
            return \Core\Modular\Repository::assetPath($module);
        }
        ...
        public static function config($key){
            return \Core\Modular\Repository::config($key);
        }
        ...
        public static function getUsedStoragePath(){
            return \Core\Modular\Repository::getUsedStoragePath();
        }
        ...
        public static function setUsed($name){
            return \Core\Modular\Repository::setUsed($name);
        }
        ...
        public static function getUsedNow(){
            return \Core\Modular\Repository::getUsedNow();
        }
        ...
        public static function getUsed(){
            return \Core\Modular\Repository::getUsed();
        }
        ...
        public static function getFiles(){
            return \Core\Modular\Repository::getFiles();
        }
        ...
        public static function getAssetsPath(){
            return \Core\Modular\Repository::getAssetsPath();
        }
        ...
        public static function asset($asset){
            return \Core\Modular\Repository::asset($asset);
        }
        ...
        public static function active($name){
            return \Core\Modular\Repository::active($name);
        }
        ...
        public static function notActive($name){
            return \Core\Modular\Repository::notActive($name);
        }
        ...
        public static function enable($name){
            return \Core\Modular\Repository::enable($name);
        }
        ...
        public static function disable($name){
            return \Core\Modular\Repository::disable($name);
        }
        ...
        public static function delete($name){
            return \Core\Modular\Repository::delete($name);
        }
        ...
        public static function update($module){
            return \Core\Modular\Repository::update($module);
        }
        ...
        public static function install($name, $version = 'dev-master', $type = 'composer', $subtree = false){
            return \Core\Modular\Repository::install($name, $version, $type, $subtree);
        }
        ...
        public static function getStubPath(){
            return \Core\Modular\Repository::getStubPath();
        }
        ...
        public static function setStubPath($stubPath){
            return \Core\Modular\Repository::setStubPath($stubPath);
        }
